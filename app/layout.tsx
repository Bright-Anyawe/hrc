...
export const metadata: Metadata = {
  ...
  title: {
    default: 'HRC Ghana | Hedge Resource Centre — Leader in Resource Consulting Ghana',
    template: '%s | HRC Ghana',
  },
  description:
  ...
  keywords: [
    ...
    'TVET courses Ghana',
    'TVET certification Ghana',
    'TVET Ashiaman',
    'TVET Accra',
    'TVET Tema',
    'TVET skills development Ghana',
    'TVET for youth Ghana',
    'TVET for women Ghana',
    'TVET instructor training Ghana',
    ...
    'TVET programmes Greater Accra',
    'TVET programmes Ashanti Region',
    'TVET programmes Northern Region',
    'TVET programmes Western Region',
    'TVET programmes Eastern Region',
    'TVET programmes Volta Region',
    'Ghana skills training',
    'Ghana vocational training programmes',
    'TVET Africa',
    'TVET Ghana CTVET',
  ],
  ...
  other: {
    ...
    'DC.subject': 'Resource Consulting, Professional Training, Skills Development, Business Advisory Ghana, HRC, Hedge Resource Centre, HR Consulting Ghana, TVET Ghana, TVET Training, Vocational Education Ghana, TVET Programmes Ghana, Ghana TVET Services',
