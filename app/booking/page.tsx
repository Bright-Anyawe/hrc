...
export const metadata: Metadata = {
  ...
  description:
    'Schedule a consultation with Hedge Resource Centre (HRC Ghana). Choose from our services — Training, Skills Development, Research, Assessment, Advisory & more. Book online instantly.',
  keywords: [
  ...
  openGraph: {
    ...
    url: 'https://www.hrcghana.com/booking',
  },
};
