          ...
          <div className={`text-white space-y-6 ${isVisible ? 'animate-slide-in-left' : 'opacity-0'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <Button asChild className="bg-hrc-red hover:bg-red-800 text-white px-6 sm:px-8 py-3 rounded-none text-xs sm:text-sm font-semibold tracking-widest uppercase transition-all duration-300 hover:shadow-xl flex items-center justify-center w-full sm:w-auto">
                <Link href="/booking" onClick={() => trackEvent('booking_started', { service: 'hero-banner' })}>
                  Book Appointment
              ...
              <Button
                onClick={() => {
                  trackEvent('cta_clicked', { cta: 'explore-services', location: 'hero-banner' });
              ...
              <Button
                onClick={() => {
                  trackEvent('cta_clicked', { cta: 'contact-us', location: 'hero-banner' });
